    ...
    return (
        <li className="list-group-item px-0">
            ...
            <div className="d-flex justify-content-between">
                ...
                <div id="game-review-content-box" className="border-end border-secondary-subtle pe-3 ps-3 w-100">
                    <div id="game-review-content">{gameReview.written_rev}</div>
                </div>
                
                <Link to="/game" className="ps-3">
                    <img 
                        id="game-review-img" 
                        className="hover-inc"
